...
2. **Implementation Loop**
  ...
  - Commit: use normal `git commit` after staging code and work-item changes. Use `kira slice task done current --commit` to commit the work-item change in the same step.
